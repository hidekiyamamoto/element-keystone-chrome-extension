window.KS={current:false,vdragging:false,
	...
	_startKS:function(){var x=document.querySelector('.currentKSP');var vdata=KS.vdragging;
		it3.ins(x,'div',['class','KSvertex','name','1','draggable','true','onmousedown','KS.vdrag(event)','style','left:'+vdata[0]+'px;top:'+vdata[1]+'px;position:absolute;width:20px;height:20px;z-index:5000;background-color:transparent;border:3px solid #000;opacity:0.7;cursor:move;']);
		it3.ins(x,'div',['class','KSvertex','name','2','draggable','true','onmousedown','KS.vdrag(event)','style','left:'+vdata[2]+'px;top:'+vdata[3]+'px;position:absolute;width:20px;height:20px;z-index:5000;background-color:transparent;border:3px solid #000;opacity:0.7;cursor:move;']);
		it3.ins(x,'div',['class','KSvertex','name','3','draggable','true','onmousedown','KS.vdrag(event)','style','left:'+vdata[4]+'px;top:'+vdata[5]+'px;position:absolute;width:20px;height:20px;z-index:5000;background-color:transparent;border:3px solid #000;opacity:0.7;cursor:move;']);
	...
	chooser:function(){document.addEventListener('click',KS._choose);},
	_choose:function(event){event.preventDefault();KS.quitchooser();KS.startKS(document.elementFromPoint(event.pageX,event.pageY));},
	quitchooser:function(){document.removeEventListener('click',KS._choose);}
};
...
if (typeof it3=='undefined') {impjs('https://cdn.rawgit.com/metaschema/it3/26fdaf47/it3.js');}
if (typeof Distort=='undefined') {impjs('https://cdn.rawgit.com/hidekiyamamoto/element-keystone-chrome-extension/591aa17a/distort.min.js');}
KS.chooser();
